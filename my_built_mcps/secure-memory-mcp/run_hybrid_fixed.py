#!/usr/bin/env python3
"""
Startup script for Secure Memory MCP Server (Fixed Hybrid Version)
"""
...
def main():
    """Main entry point for the fixed hybrid server"""
    print("🔒 Starting Secure Memory MCP Server (Fixed Hybrid Version)")
    print("=" * 60)
    
    try:
        from server_hybrid_fixed import main as server_main
        server_main()
